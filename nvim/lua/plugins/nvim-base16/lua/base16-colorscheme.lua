-- Using https://github.com/RRethy/nvim-base16 as a base
-- Expanded with https://github.com/echasnovski/mini.nvim base16 plugin
...
function M.setup(colors)
	...
	hi.Folded                             = { guifg = M.colors.base04, guibg = M.colors.base01, gui = nil, guisp = nil, ctermfg = M.colors.cterm04, ctermbg = M.colors.cterm01 }
  ...
  hi.PmenuExtra                         = { guifg = M.colors.base05, guibg = M.colors.base01, gui = nil, guisp = nil, ctermfg = M.colors.cterm05, ctermbg = M.colors.cterm01 }
  hi.PmenuExtraSel                      = { guifg = M.colors.base05, guibg = M.colors.base01, gui = 'reverse', guisp = nil, ctermfg = M.colors.cterm05, ctermbg = M.colors.cterm01 }
  hi.PmenuKind                          = { guifg = M.colors.base05, guibg = M.colors.base01, gui = nil, guisp = nil, ctermfg = M.colors.cterm05, ctermbg = M.colors.cterm01 }
  hi.PmenuKindSel                       = { guifg = M.colors.base05, guibg = M.colors.base01, gui = 'reverse', guisp = nil, ctermfg = M.colors.cterm05, ctermbg = M.colors.cterm01 }
  ...
  hi.PmenuThumb                         = { guifg = nil, guibg = M.colors.base03, gui = nil, guisp = nil, ctermfg = nil, ctermbg = M.colors.cterm03 }
	...
	hi.FloatBorder       = { guifg = M.colors.base0C, guibg = M.colors.base00, gui = nil, guisp = nil, ctermfg = M.colors.cterm05, ctermbg = M.colors.cterm00 }
	...
	if M.config.cmp then
		...
		hi.CmpDocBorder             = { guifg = M.colors.base05, guibg = M.colors.base00, gui = nil, guisp = nil, ctermfg = M.colors.cterm05, ctermbg = M.colors.cterm00 }
		hi.CmpBorder                = { guifg = M.colors.base05, guibg = M.colors.base01, gui = nil, guisp = nil, ctermfg = M.colors.cterm05, ctermbg = M.colors.cterm00 }
	...
	if M.config.nvim_tree then
		hi.NvimTreeExecFile = { guifg = M.colors.base0B, guibg = nil, gui = 'bold', guisp = nil, ctermfg = M.colors.cterm0B, ctermbg = nil}
		hi.NvimTreeFolderIcon = { guifg = M.colors.base03, guibg = nil, gui = nil, guisp = nil, ctermfg = M.colors.cterm03, ctermbg = nil}
		hi.NvimTreeGitDeleted = { guifg = M.colors.base08, guibg = nil, gui = nil, guisp = nil, ctermfg = M.colors.cterm08, ctermbg = nil}
		hi.NvimTreeGitDirty = { guifg = M.colors.base08, guibg = nil, gui = nil, guisp = nil, ctermfg = M.colors.cterm08, ctermbg = nil}
		hi.NvimTreeGitMerge = { guifg = M.colors.base0C, guibg = nil, gui = nil, guisp = nil, ctermfg = M.colors.cterm0C, ctermbg = nil}
		hi.NvimTreeGitNew = { guifg = M.colors.base0A, guibg = nil, gui = nil, guisp = nil, ctermfg = M.colors.cterm0A, ctermbg = nil}
		hi.NvimTreeGitRenamed = { guifg = M.colors.base0E, guibg = nil, gui = nil, guisp = nil, ctermfg = M.colors.cterm0E, ctermbg = nil}
		hi.NvimTreeGitStaged = { guifg = M.colors.base0B, guibg = nil, gui = nil, guisp = nil, ctermfg = M.colors.cterm0B, ctermbg = nil}
		hi.NvimTreeImageFile = { guifg = M.colors.base0E, guibg = nil, gui = 'bold', guisp = nil, ctermfg = M.colors.cterm0E, ctermbg = nil}
		hi.NvimTreeIndentMarker = { guifg = M.colors.base03, guibg = nil, gui = nil, guisp = nil, ctermfg = M.colors.cterm03, ctermbg = nil}
		hi.NvimTreeOpenedFile = { guifg = M.colors.base0B, guibg = nil, gui = 'bold', guisp = nil, ctermfg = M.colors.cterm0B, ctermbg = nil}
		hi.NvimTreeRootFolder = { guifg = M.colors.base0E, guibg = nil, gui = nil, guisp = nil, ctermfg = M.colors.cterm0E, ctermbg = nil}
		hi.NvimTreeSpecialFile = { guifg = M.colors.base0D, guibg = nil, gui = 'bold,underline', guisp = nil, ctermfg = M.colors.cterm0D, ctermbg = nil}
		hi.NvimTreeSymlink = { guifg = M.colors.base0F, guibg = nil, gui = 'bold', guisp = nil, ctermfg = M.colors.cterm0F, ctermbg = nil}
		hi.NvimTreeWindowPicker = { guifg = M.colors.base05, guibg = M.colors.base01, gui = "bold", guisp = nil, ctermfg = M.colors.cterm05, ctermbg = M.colors.cterm01}
	end

	if M.config.leap then
		hi.LeapMatch = { guifg = M.colors.base03, guibg = nil, gui = nil, guisp = nil, ctermfg = M.colors.cterm03, ctermbg = nil}
		hi.LeapLabelPrimary = { guifg = M.colors.base0A, guibg = nil, gui = nil, guisp = nil, ctermfg = M.colors.cterm0A, ctermbg = nil}
		hi.LeapLabelSecondary = { guifg = M.colors.base0D, guibg = nil, gui = nil, guisp = nil, ctermfg = M.colors.cterm0D, ctermbg = nil}
		hi.LeapLabelSelected = { guifg = M.colors.base02, guibg = nil, gui = nil, guisp = nil, ctermfg = M.colors.cterm02, ctermbg = nil}
	end
    ...
    hi.BlinkCmpKind = { guifg = M.colors.base05, guibg = M.colors.base00, gui = nil, guisp = nil, ctermfg = M.colors.cterm02, ctermbg = M.colors.cterm00 }
		...
		hi.BlinkCmpKindField = { guifg = M.colors.base0B, guibg = nil, gui = nil, guisp = nil, ctermfg = M.colors.cterm0B, ctermbg = nil }
		...
		hi.BlinkCmpKindModule = { guifg = M.colors.base0D, guibg = nil, gui = nil, guisp = nil, ctermfg = M.colors.cterm0D, ctermbg = nil }
		hi.BlinkCmpKindProperty = { guifg = M.colors.base0D, guibg = nil, gui = nil, guisp = nil, ctermfg = M.colors.cterm0D, ctermbg = nil }
		hi.BlinkCmpKindUnit = { guifg = M.colors.base0B, guibg = nil, gui = nil, guisp = nil, ctermfg = M.colors.cterm0B, ctermbg = nil }
		...
		hi.BlinkCmpKindSnippet = { guifg = M.colors.base0C, guibg = nil, gui = nil, guisp = nil, ctermfg = M.colors.cterm0C, ctermbg = nil }
		hi.BlinkCmpKindColor = { guifg = M.colors.base0F, guibg = nil, gui = nil, guisp = nil, ctermfg = M.colors.cterm0F, ctermbg = nil }
		hi.BlinkCmpKindFile = { guifg = M.colors.base0D, guibg = nil, gui = nil, guisp = nil, ctermfg = M.colors.cterm0D, ctermbg = nil }
		hi.BlinkCmpKindReference = { guifg = M.colors.base0F, guibg = nil, gui = nil, guisp = nil, ctermfg = M.colors.cterm0F, ctermbg = nil }
		hi.BlinkCmpKindFolder = { guifg = M.colors.base0D, guibg = nil, gui = nil, guisp = nil, ctermfg = M.colors.cterm0D, ctermbg = nil }
		hi.BlinkCmpKindEnumMember = { guifg = M.colors.base09, guibg = nil, gui = nil, guisp = nil, ctermfg = M.colors.cterm09, ctermbg = nil }
		hi.BlinkCmpKindConstant = { guifg = M.colors.base09, guibg = nil, gui = nil, guisp = nil, ctermfg = M.colors.cterm09, ctermbg = nil }
		hi.BlinkCmpKindStruct = { guifg = M.colors.base0D, guibg = nil, gui = nil, guisp = nil, ctermfg = M.colors.cterm0D, ctermbg = nil }
		hi.BlinkCmpKindEvent = { guifg = M.colors.base0D, guibg = nil, gui = nil, guisp = nil, ctermfg = M.colors.cterm0D, ctermbg = nil }
		hi.BlinkCmpKindOperator = { guifg = M.colors.base0C, guibg = nil, gui = nil, guisp = nil, ctermfg = M.colors.cterm0C, ctermbg = nil }
		hi.BlinkCmpKindTypeParameter = { guifg = M.colors.base0A, guibg = nil, gui = nil, guisp = nil, ctermfg = M.colors.cterm0A, ctermbg = nil }
		hi.BlinkCmpKindCopilot = { guifg = M.colors.base0C, guibg = nil, gui = nil, guisp = nil, ctermfg = M.colors.cterm0C, ctermbg = nil }
  end
