...
function M.setup(colors)
	...
	if M.config.nvim_tree then
		hi.NvimTreeExecFile = { guifg = M.colors.base0B, guibg = nil, gui = 'bold', guisp = nil }
		hi.NvimTreeFolderIcon = { guifg = M.colors.base03, guibg = nil, gui = nil, guisp = nil }
		hi.NvimTreeGitDeleted = { guifg = M.colors.base08, guibg = nil, gui = nil, guisp = nil }
		hi.NvimTreeGitDirty = { guifg = M.colors.base08, guibg = nil, gui = nil, guisp = nil }
		hi.NvimTreeGitMerge = { guifg = M.colors.base0C, guibg = nil, gui = nil, guisp = nil }
		hi.NvimTreeGitNew = { guifg = M.colors.base0A, guibg = nil, gui = nil, guisp = nil }
		hi.NvimTreeGitRenamed = { guifg = M.colors.base0E, guibg = nil, gui = nil, guisp = nil }
		hi.NvimTreeGitStaged = { guifg = M.colors.base0B, guibg = nil, gui = nil, guisp = nil }
		hi.NvimTreeImageFile = { guifg = M.colors.base0E, guibg = nil, gui = 'bold', guisp = nil }
		hi.NvimTreeIndentMarker = { guifg = M.colors.base03, guibg = nil, gui = nil, guisp = nil }
		hi.NvimTreeOpenedFile = { guifg = M.colors.base0B, guibg = nil, gui = 'bold', guisp = nil }
		hi.NvimTreeRootFolder = { guifg = M.colors.base0E, guibg = nil, gui = nil, guisp = nil }
		hi.NvimTreeSpecialFile = { guifg = M.colors.base0D, guibg = nil, gui = 'bold,underline', guisp = nil }
		hi.NvimTreeSymlink = { guifg = M.colors.base0F, guibg = nil, gui = 'bold', guisp = nil }
		hi.NvimTreeWindowPicker = { guifg = M.colors.base05, guibg = M.colors.base01, gui = "bold", guisp = nil }
	end

	if M.config.leap then
		hi.LeapMatch = { guifg = M.colors.base03, guibg = nil, gui = nil, guisp = nil }
		hi.LeapLabelPrimary = { guifg = M.colors.base0A, guibg = nil, gui = nil, guisp = nil }
		hi.LeapLabelSecondary = { guifg = M.colors.base0D, guibg = nil, gui = nil, guisp = nil }
		hi.LeapLabelSelected = { guifg = M.colors.base02, guibg = nil, gui = nil, guisp = nil }
	end
